...
//   // === CANVAS DRAWING (keeping your exact existing implementation) ===
//   useEffect(() => {
...
//   // Wrapper functions that bind deviceId
...
//     // Check if any label is customized for this device
...
//   // (fetchDeviceData, fetchPowerStatusHistory, handlePowerToggle, handleAutoModeToggle, etc.)
//   // Keep them exactly as they are — just remove the old label state and functions
...
//   //         <div className="device-info-card">
//   //           <div>
//   //             <div className="device-info-header"><h3 className="section-title">Device Connection Status and Power:</h3></div>
...
//   //                       <span className={nbWaiting ? "status-waiting" : ""}>{getStatusText(isPowerOn, deviceData.nbGenerator.timestamp, nbWaiting)}</span>
...
//   //                 {loadingHistory ? <div className="status-history-loading">Loading history...</div> :
//   //                   powerStatusHistory.length === 0 ? <div className="status-history-empty">No status history available</div> :
//   //                     <div className="status-history-table-container">
//   //                       <table className="status-history-table">
//   //                         <thead><tr><th>Date</th><th>Status</th><th>Duration</th></tr></thead>
//   //                         <tbody>
//   //                           {powerStatusHistory.map((record, index) => (
//   //                             <tr key={record.id} className={index === 0 ? 'current-status' : ''}>
//   //                               <td>{new Date(record.timestamp).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit' })}</td>
...
//   //               <div className="config-row">
//   //                 <div className="config-item">
//   //                   <label><EditableLabel deviceId={id} attributeKey="total_running_hours" onSave={handleSaveLabel} onReset={handleResetLabel} />:</label>
//   //                   <span className="config-value">{parseVal(deviceData.nbGenerator.total_running_hours)} H</span>
//   //                 </div>
//   //                 <div className="config-item">
...
//   //               <div className="config-row">
//   //                 <div className="config-item">
//   //                   <label><EditableLabel deviceId={id} attributeKey="total_water_outlet" onSave={handleSaveLabel} onReset={handleResetLabel} />:</label>
...
//   //           {/* Charts - NOW RECEIVES DEVICE ID FOR LABELS */}
...
//   //                         <div className="alert-label">{getLabel(key)}</div>
...
//                     <table className="status-history-table">
//                       <thead>
//                         <tr><th>Date</th><th>Status</th><th>Duration</th></tr>
//                       </thead>
//                       <tbody>
//                         {powerStatusHistory.map((record, index) => (
//                           <tr key={record.id} className={index === 0 ? 'current-status' : ''}>
