...
const Operatorinfo = () => {
  ...
  if (loading) {
    return (
      <div className="edit-operator-loading-backdrop">
        <div className="edit-operator-loading-spinner"></div>
        <div className="edit-operator-loading-text">Loading operator data...</div>
      </div>
    );
  }
  ...
  return (
    <>
      <div className="edit-operator-header">
        <h1 className="edit-operator-title">Edit Operator Details</h1>
        <button
          className="edit-operator-action-btn"
          onClick={handleEditToggle}
          disabled={loading}
        >
          {isEditMode ? (loading ? "Saving..." : "Save Changes") : "Edit"}
      ...
      <div className="edit-operator-page-container">
        <div className="edit-operator-content-card">
          <div className="edit-operator-form-wrapper">
            <h2>Change Details:</h2>

            <div className="edit-operator-form-row edit-operator-two-col">
              <div className="edit-operator-form-group">
                <label>Operator Name</label>
                <input
                  type="text"
                  placeholder="Enter name"
              ...
              <div className="edit-operator-form-group">
                ...
                <input
                  ...
                  value={operatorInfo.email}
                  readOnly
                  className="edit-operator-readonly-field"
                />
              </div>
            </div>
            ...
            {/* The "Role" field was commented out in your original code, but styles are available if you re-enable it. */}
            {/* <div className="edit-operator-form-row">
              <div className="edit-operator-form-group">
                <label>Role</label>
                <input
                  type="text"
